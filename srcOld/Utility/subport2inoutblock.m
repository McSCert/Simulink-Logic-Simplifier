...
%       blkName = subport2inoutblock(firstInport);
    ...
    if strcmp(parentType, 'ModelReference')
        inoutBlock = cell2mat(find_in_models(parent, 'SearchDepth', 1, 'BlockType', ...
            blockType, 'Port', num2str(pNum)));
    else
        inoutBlock = cell2mat(find_system(parent, 'SearchDepth', 1, 'BlockType', ...
            blockType, 'Port', num2str(pNum)));
    end
end